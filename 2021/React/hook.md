...
## hook的优点
```js
1. 编写hooks为函数式编程，每个功能都包裹在函数中，整体风格更清爽，更优雅
2. 每调用useHook一次都会生成一份独立的状态
3. 通过自定义hook能够更好的封装我们的功能
4. hooks的出现，使函数组件的功能得到了扩充，拥有了类组件相似的功能，在我们日常使用中，使用hooks能够解决大多数问题，并且还拥有代码复用机制，因此优先考虑hooks
```
---
## react-Hook
```js
